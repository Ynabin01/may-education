        ...
        <div class="row">
            <div class="apply-form-wrapper">
                <div class="contact-form">
                    <form action="{{ route('contactstore') }}" method="POST" enctype='multipart/form-data' id="apply-form">
                        @csrf
                        <input type="text" id="name" placeholder="Your Full Name*" name="first_name" required="true">
                        <input type="text" id="contact" placeholder="Your Phone Number*" name="number" required="true">
                        <input type="email" id="email" placeholder="Your Email Address*" name="email" required="true">
                        <input type="text" id="country" placeholder="Applied Country*" name="country" required="true">
                        <!--<input type="text" id="apply" placeholder="Applied Country..." name="subject" required="true">-->
                        <div class="form-field col-md-12">
                            <label>Upload Your CV</label>
                            <input type="file" name="file" class="form-control file-upload">
                        </div>
